...
import SustainabilityHero from "@atoms/pretty/policysaurus/SustainabilityHero.svg";

const PolicysaurusSustainabilityHeader = () => {
  ...
  return h(
    ...
    h(
      ...
      h(Image, null, h("img", { src: SustainabilityHero })),
      h(
        Content,
        null,
        h("h1", null, "Policysaurus for Sustainability Topics"),
...
export default PolicysaurusSustainabilityHeader;
