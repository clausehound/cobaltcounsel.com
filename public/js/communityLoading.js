...
var communityData = {
  "Ryerson Business Law Clinic":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/Ryerson-Buusiness-law-clinic-lesson-on-legal-contracts.png",
  "Bizdom in Detroit":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/Bizdom-in-Detroit.jpg",
  "Detroit Startup":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/Detroit-startup.jpg",
  "Detroit Innovation":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/Detroit-Innovation.jpg",
  "Proud Supporter of the Power Up Sales Challenge":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/Cobalt-Sponsors-Power-Up-Sales-Challenge.jpg",
  "Cobalt Makers and Shakers":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/Cobalt-Sponsors-Makers-and-Shakers-Founders-and-Funders-event-at-the-University-Club.jpg",
  "Team @ Steamwhistle":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/Teamwhistle-@-Steam.jpg",
  "CEO Circle at Legal Innovation Zone":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/CEO-Circle-from-14-Mar-2017-LIZ-Letter.jpg",
  "Supporting Environment Hamilton Cold Weather Readiness":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/BMW-Foundation-Event-Hamilton-4.jpg",
  "Proud Sponsor of the Power Up Sales Challenge":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/5th-Annual-Power-Up-Sales-Challenge.jpg",
  "HackJustice @ MaRS":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/HackJustice-at-MRS.jpg",
  "Innovation Factory Hamilton":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/Innovation-Factory-Hamilton-e1490647142345.jpg",
  "Hacker Studios":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/hacker-studios.jpg",
  "Social Innovation at Work, at Innovation Works":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/InnovationWorks-3.jpg",
  "Kireitsu Forum at Techalliance":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/kireitsu-forum.jpg",
  "Mohawk Surge Funding Event":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/Mohawk-surge.jpg",
  "TSX Speaking Engagement":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/Rajah-at-TSX.jpg",
  "Teaching at Western Accelerator":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/Teaching-at-Western-Accelerator-2017.jpg",
  "Lecture at Ryerson University":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/Lecture-at-Ryerson-University.jpg",
  "Teaching at Ryerson U":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/Teaching-at-Ryerson-U.jpg",
  "OCE Discovery":
    "http:// cobaltcounselw.wpengine.com/wp-content/uploads/2017/03/OCE-discovery-2016.jpg",
...
// trigger of asynchronous loading once page has loaded
...
function onLoading(downloadingImageLoad, image, key, i) {
  downloadingImageLoad.onload = function() {
    ...
    currentPicture.addEventListener(
      "click",
      function() {
...
function pictureOnClick(dict, image) {
  ...
  imageHolder.innerHTML =
    "<div id='enlargedBackground'></div><a href='javascript:void(0)''></a><img id='enlarged-image' src='" +
    dict +
    "'> </img>";
...
function fixSize(image, dict) {
  ...
  // Adds on-click effect to close enlarged image box when ever anywhere is clicked.
  // Must be set after delay so first click doesnt trigger close effect.
  setTimeout(
    function() {
  ...
  // Centering handler for image that is bigger than bordered box and more contrained by height
    ...
    currentImage.style.marginLeft =
      ((iHWidth - width / (height / iHHeight)) / 2).toString() + "px";
    ...
    currentImage.style.marginTop =
      ((iHHeight - height / (width / iHWidth)) / 2).toString() + "px";
    ...
    mapDiv.style.height =
      parseInt(
        document.defaultView
          .getComputedStyle(contactDiv, null)
          .getPropertyValue("height")
      ).toString() + "px";
  } else if (flowchart.currentStyle) {
    // For IE
    mapDiv.style.height =
      parseInt(contactDiv.currentStyle["height"]).toString() + "px";
  }
}
