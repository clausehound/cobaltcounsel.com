...
<p>Cobalt has a complete pricing menu available upon request. Selected pricing options are below:</p>`;
  ...
  const rows = [[
    ...
    '<b>Deep and detailed document review/editing</b> session 3', '$175 + Tax (+/- on request)',
  ],[
    '<b>Same-Day Incorporation</b>4', '$350 + Tax + Government Fees',
  ], [
    "<b>Drafting of your Shareholders' Agreement, Vesting Agreement, Hiring Agreements, Many Others</b> 4", 'Fast, 100% Fixed Fee'
  ]];
