...
(function($) {
  ...
  $(document).ready(function() {
    ...
    $("#tech-driven-link").click(function() {
      $("html, body").animate(
        {
          scrollTop: $("#tech-driven").offset().top
        },
        500
      );
    });
    ...
    $navLi.each(function() {
      if ($(this).find("ul").length > 0 && !$(this).hasClass("has_children")) {
        ...
        $(this)
          ...
          .first()
          .after(
            '<p class="dropdownmenu"><i class="fa fa-angle-down"></i></p>'
          );
      }
    });
  ...
  $(document).ready(function() {
    "use strict";
    $(
      '#site-navigation a[href*="#"]:not([href="#"]), a.post-comments[href*="#"]:not([href="#"])'
    ).bind("click", function() {
      var headerHeight;
      var hash = this.hash;
  ...
  function scrolled() {
    ...
    if (jQuery(window).width() >= 751) {
      ...
      jQuery("section").each(function() {
        ...
        if (
          prallax_one_scrollTop >= thisBegin &&
          prallax_one_scrollTop <= thisEnd
        ) {
          isInOneSection = true;
